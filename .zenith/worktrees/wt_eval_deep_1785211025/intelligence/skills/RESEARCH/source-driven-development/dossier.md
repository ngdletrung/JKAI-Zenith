...
- File: intelligence/skills/RESEARCH/source-driven-development/dossier.md
- Role: Sovereign Knowledge Protocol - Assimilated from agent-skills v1.0 (MIT - Addy Osmani)
- Deck ID: #4008 | Domain: RESEARCH
- Ownership: Mr LeeTrung
- Status: Active | Version: SDS v1.0
-->

# DOSSIER: #4008 SOURCE-DRIVEN DEVELOPMENT
...
- Moi hanh vi cua JKAI khi kich hoat skill #4008 phai tuan thu giao thuc tren.
- Khong dua ra ket qua cuoi cung neu chua hoan thanh checklist cuoi muc Verification.

*Deck #4008 | Property of Master LeeTrung | JKAI Zenith*
