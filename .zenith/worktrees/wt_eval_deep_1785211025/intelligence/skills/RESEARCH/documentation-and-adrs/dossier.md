...
- File: intelligence/skills/RESEARCH/documentation-and-adrs/dossier.md
- Role: Sovereign Knowledge Protocol - Assimilated from agent-skills v1.0 (MIT - Addy Osmani)
- Deck ID: #4012 | Domain: RESEARCH
- Ownership: Mr LeeTrung
- Status: Active | Version: SDS v1.0
-->

# DOSSIER: #4012 GHI NHAN KIEN TRUC
...
- Moi hanh vi cua JKAI khi kich hoat skill #4012 phai tuan thu giao thuc tren.
- Khong dua ra ket qua cuoi cung neu chua hoan thanh checklist cuoi muc Verification.

*Deck #4012 | Property of Master LeeTrung | JKAI Zenith*
