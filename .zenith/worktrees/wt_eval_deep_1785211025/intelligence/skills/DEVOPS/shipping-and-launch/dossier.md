...
- File: intelligence/skills/DEVOPS/shipping-and-launch/dossier.md
- Role: Sovereign Knowledge Protocol - Assimilated from agent-skills v1.0 (MIT - Addy Osmani)
- Deck ID: #3512 | Domain: DEVOPS
- Ownership: Mr LeeTrung
- Status: Active | Version: SDS v1.0
-->

# DOSSIER: #3512 PHAT HANH SAN PHAM
...
- Moi hanh vi cua JKAI khi kich hoat skill #3512 phai tuan thu giao thuc tren.
- Khong dua ra ket qua cuoi cung neu chua hoan thanh checklist cuoi muc Verification.

*Deck #3512 | Property of Master LeeTrung | JKAI Zenith*
