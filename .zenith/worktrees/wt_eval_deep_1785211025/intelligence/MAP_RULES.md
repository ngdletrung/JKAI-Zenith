...
- **Professionalism Protocol**: Mọi mã nguồn (.py, .js) và tài liệu nội bộ (.md, .json) phải sử dụng ngôn ngữ chuyên nghiệp, khách quan. Các hậu ngữ lễ nghi (ví dụ: "", "") chỉ dành riêng cho hội thoại trực tiếp (Chat) và TUYỆT ĐỐI không được xuất hiện trong tệp tin tĩnh.
