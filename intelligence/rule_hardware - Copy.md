...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **qwen3:4b** | 2.5 GB | 2048 | 0.05 | **100%** | 0.85 | 1.05 | **GPU/VRAM** | RECEPTIONIST / PLANNER / CRITIC |
| **llama3.2:3b** | 2.0 GB | 2048 | 0.40 | **100%** | 0.90 | 1.10 | **GPU/VRAM** | CHAT / SUMMARIZER / EXECUTOR |
| **qwen3:0.6b** | 0.5 GB | 2048 | 0.10 | **OFFLINE** | 0.90 | 1.10 | **CPU/RAM** | RECEPT_ASK_USER / CICE / DISPATCHER |
| **nomic-embed-text** | 0.3 GB | 512 | 0.00 | **OFFLINE** | 1.00 | 1.00 | **CPU/RAM** | EMBEDDER |
| **qwen3.5:latest** | 6.6 GB | 4096 | 0.45 | **OFFLINE** | 0.92 | 1.10 | **CPU/RAM** | RESERVE_AGENT |
| **phi4-mini:latest** | 2.5 GB | 4096 | 0.20 | **OFFLINE** | 0.88 | 1.10 | **CPU/RAM** | TRANSLATOR / CRITIC_BETA |
...
# OLLAMA_NUM_THREAD khoa chat luong tinh toan vao 10 nhan vat ly, tranh hien tuong Context Switching va nghen bang thong RAM

---

## 🏗️ 2.5. Neural Hardware Profiles

| Profile Name | num_ctx | Temp | num_gpu | repeat_p | Purpose |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **FAST_RESPONSE** | 4096 | 0.4 | 100 | 1.1 | Chat tức thì, phản xạ nhanh. |
| **ELITE_REASONING** | 8192 | 0.0 | 0 | 1.05 | Suy luận logic sâu, giải quyết vấn đề. |
| **RAM_OPTIMIZED** | 4096 | 0.2 | 0 | 1.1 | Tiết kiệm tài nguyên, chạy ổn định trên CPU. |
| **STABLE_SYNC** | 2048 | 0.0 | 0 | 1.0 | Đồng bộ hóa dữ liệu, nhúng vector. |
| **ULTRA_ART** | 0 | 0.0 | 100 | -1 | Tạo ảnh chất lượng cao. |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| EMBEDDER | nomic-embed-text:latest | **CPU/RAM** | 1024 | 0.0 | 0 | 20 | 1.0 | 1.0 | **-1** | STABLE_SYNC |
| RECEPTIONIST | qwen3:4b | **GPU/VRAM** | 2048 | 0.10 | 100 | 0 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| RECEPT_ASK_USER | qwen3:0.6b | **CPU/RAM** | 2048 | 0.10 | 0 | 20 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| CICE | qwen3:0.6b | **CPU/RAM** | 2048 | 0.10 | 0 | 20 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| CHAT | llama3.2:3b | **GPU/VRAM** | 2048 | 0.40 | 100 | 0 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| EXECUTOR | llama3.2:3b | **GPU/VRAM** | 2048 | 0.05 | 100 | 0 | 0.85 | 1.05 | **-1** | FAST_RESPONSE |
| EXECUTOR_ALPHA | qwen3:4b | **GPU/VRAM** | 2048 | 0.0 | 100 | 0 | 0.85 | 1.05 | **-1** | FAST_RESPONSE |
| PLANNER | qwen3:4b | **GPU/VRAM** | 2048 | 0.05 | 100 | 0 | 0.85 | 1.05 | **-1** | FAST_RESPONSE |
| CRITIC | qwen3:4b | **GPU/VRAM** | 2048 | 0.05 | 100 | 0 | 0.85 | 1.05 | **-1** | FAST_RESPONSE |
| DISPATCHER | qwen3:0.6b | **CPU/RAM** | 2048 | 0.0 | 0 | 20 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| SUMMARIZER | llama3.2:3b | **GPU/VRAM** | 2048 | 0.10 | 100 | 0 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| COMPRESSOR | qwen3:0.6b | **CPU/RAM** | 2048 | 0.1 | 0 | 20 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| DATA_SCOUT | qwen3:0.6b | **CPU/RAM** | 2048 | 0.20 | 0 | 20 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| CRITIC_ALPHA | qwen3:0.6b | **CPU/RAM** | 2048 | 0.05 | 0 | 20 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| EXECUTOR_BETA | qwen3:0.6b | **CPU/RAM** | 2048 | 0.20 | 0 | 20 | 0.90 | 1.10 | **-1** | FAST_RESPONSE |
| CRITIC_BETA | phi4-mini:latest | **CPU/RAM** | 4096 | 0.30 | 0 | 20 | 0.90 | 1.10 | **-1** | RAM_OPTIMIZED |
| RESERVE_AGENT | qwen3.5:latest | **CPU/RAM** | 4096 | 0.45 | 0 | 20 | 0.92 | 1.10 | **-1** | RAM_OPTIMIZED |
| VISION | moondream:latest | **CPU/RAM** | 2048 | 0.1 | 0 | 20 | 0.90 | 1.10 | **-1** | RAM_OPTIMIZED |
| VOICE | faster-whisper | **CPU/RAM** | 1024 | 0.0 | 0 | 0 | 1.0 | 1.0 | **-1** | STABLE_SYNC |
| TRANSLATOR | phi4-mini:latest | **CPU/RAM** | 4096 | 0.2 | 0 | 20 | 0.88 | 1.10 | **-1** | RAM_OPTIMIZED |
| GRAPHIC_MASTER | SDXL-Turbo-ROCm | **GPU/VRAM** | 0 | 0.0 | 100 | 0 | -1 | -1 | 0 | ULTRA_ART |
