...
INTENT_BOOKS = {
    ...
    "PLAN": {
        ...
        "technical": ["system design", "distributed architecture", "multi-agent orchestration", "deployment strategy", "execution plan", "task graph", "dag planning", "rag pipeline", "agentic workflow", "memory architecture"],
    },
    "TRANSLATE": {
...
ADVANCED_INTENT_BOOKS = {
    ...
    "SEARCH": {
        ...
        "technical": ["web crawling", "serp api", "real-time data acquisition", "osint", "semantic search", "vector search", "hybrid search", "bm25", "rerank"],
    },
    "RESEARCH": {
...
DOMAIN_BOOKS = {
    "AI_AGENT": ["agentic", "multi-agent", "orchestrator", "dispatcher", "planner", "critic", "reflection", "memory", "retrieval", "rag", "embedding", "rerank", "reasoning", "thinking", "tool calling", "knowledge graph", "autonomous ai", "llm", "prompt engineering", "langchain", "llamaindex", "qdrant", "chroma", "vector store", "semantic search", "fine-tuning", "lora", "transformers", "openai", "anthropic", "gemini", "claude", "mcp", "model context protocol", "function calling", "zero-shot", "few-shot", "chain of thought", "cot", "react pattern"],
    ...
    "MEMORY": ["bộ nhớ", "ký ức", "bộ não", "memory", "cache", "redis", "qdrant", "database", "dữ liệu", "lịch sử", "ngữ cảnh", "bối cảnh", "context", "history", "log", "trace", "session", "cookie", "local storage", "session storage", "indexeddb", "sqlite", "mysql", "mariadb", "oracle", "sql server", "memcached", "etcd", "zookeeper", "consul", "vector db", "pinecone", "milvus", "weaviate", "faiss"],
}
