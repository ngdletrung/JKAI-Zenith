"""
JKAI ZENITH — VERIFICATION LAYER: FAILURE CLASSIFIER (v2.1)
File: core/cognitive/failure_classifier.py

Phân loại chi tiết nguyên nhân thất bại của tác chiến:
TRANSIENT -> RETRY
TOOL_FAILURE -> SUBSTITUTE_CAPABILITY
MODEL_FAILURE -> CHANGE_MODEL
PLAN_FAILURE -> REPLAN
VERIFICATION_FAILURE -> DIAGNOSE_AND_REPAIR
INPUT_FAILURE -> CLARIFICATION_REQUIRED
POLICY_FAILURE -> ABORTED (Terminal State)
"""
