...
# NOTE: Module was vendored into the prompt_engine package. The legacy
# sys.path bootstrap is intentionally removed — relative imports below
# resolve via the prompt_engine.claw_compactor.fusion package. The old
# hack inserted prompt_engine/ at sys.path[0], colliding with the root
# `core` package and breaking `import prompt_assembler`.

from .base import FusionContext, FusionResult, FusionStage
from .pipeline import FusionPipeline
from .cortex import Cortex
from .quantum_lock import QuantumLock
from .photon import PhotonStage
from .ionizer import Ionizer
from .log_crunch import LogCrunch
from .search_crunch import SearchCrunch
from .diff_crunch import DiffCrunch
from .semantic_dedup import SemanticDedup, dedup_across_messages
from .structural_collapse import StructuralCollapse
from .neurosyntax import Neurosyntax
...
from ..tokenizer_optimizer import optimize_tokens as _optimize_tokens
